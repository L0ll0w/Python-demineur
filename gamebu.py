...
def start_game(w, h, mines, difficulty_name):
    ...
    def reveal_cells(row, col):
        ...
        if clicked_cells[row][col] == 1 or (row, col) in mines_pos:
            return
                ...
                for col in range(CellCount):
                    if flags[row][col] == 1:
                        ...
                        if value == -1:
                            ...
                            pygame.draw.rect(screen, (200, 200, 200), pygame.Rect(col * GridSize, row * GridSize, GridSize, GridSize))
